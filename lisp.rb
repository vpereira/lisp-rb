...
# parse coverts the list of tokens produced by the `tokenize` into an Abstract Syntax Tree (AST),
# which represents the input code's structure. The AST gets then used by `eval_ast`
def parse(tokens)
...
# Evaluate the AST generated by `parse` within the env context
